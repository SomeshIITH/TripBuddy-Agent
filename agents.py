...
def _json_from_llm(text: Any) -> dict:
    ...
    if not match:
        print("Warning: No JSON structure found in output. Using fallback.")
        return {"allowed": True, "reason": "No JSON returned by LLM"}
    ...
    try:
        ...
        return {"allowed": True, "reason": "Failed to parse JSON"}
